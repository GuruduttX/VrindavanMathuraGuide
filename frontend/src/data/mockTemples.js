...
export const temples = [
  ...
  },
  {
    ...
    darshan: {
      timings: '4:30 AM - 1:00 PM, 4:00 PM - 9:00 PM (Daily)',
      specialNotes: 'Well-organized queue system. Clean and spacious premises. Guest house accommodation available for devotees. Photography allowed in designated areas only.',
    ...
    faqs: [
      {
        question: 'What is the difference between ISKCON temple and traditional Vrindavan temples?',
        answer: 'ISKCON follows the Gaudiya Vaishnava tradition but with modern organizational structure. The temple has systematic queue management, cleanliness standards, and welcomes international visitors. Traditional temples may have more localized customs and Hindi-dominant interactions.'
      },
      {
        question: 'Can foreigners and non-Hindus visit the temple?',
        answer: 'Yes, ISKCON Vrindavan warmly welcomes visitors of all nationalities and backgrounds. English-speaking volunteers are available to guide international guests. The temple philosophy emphasizes universal spirituality.'
      },
      {
        question: 'Are there accommodation facilities for pilgrims?',
        answer: 'Yes, ISKCON operates a guest house with rooms available for devotees and pilgrims. Advance booking is recommended, especially during festival seasons. Contact the temple office for reservations.'
      }
    ]
  },
  {
    ...
    darshan: {
      timings: 'Summer: 5:30 AM - 12:00 PM, 4:30 PM - 9:30 PM | Winter: 5:30 AM - 12:00 PM, 4:00 PM - 8:30 PM',
      specialNotes: 'Evening light and sound show at 7:00 PM (highly recommended). The temple is beautifully illuminated after sunset. Spacious premises with gardens and fountains.',
      crowdLevel: 'High (especially during evening shows)'
    },
    visitorGuidance: [
    ...
    faqs: [
      {
        question: 'What is special about Prem Mandir\'s evening show?',
        answer: 'The evening light and sound show illuminates the entire marble structure with synchronized music and colored lights, narrating the divine pastimes of Radha Krishna. The show lasts approximately 20-25 minutes and is a major attraction.'
      },
      {
        question: 'How much time should I allocate for visiting Prem Mandir?',
        answer: 'Plan for at least 1.5 to 2 hours. This includes darshan, viewing the marble carvings, walking through the gardens, and watching the evening light show if visiting after sunset.'
      },
      {
        question: 'Is there an entry fee for Prem Mandir?',
        answer: 'No, entry to Prem Mandir is completely free. There are no charges for darshan or viewing the evening light show. Donations are voluntary.'
      }
    ]
  },
  {
    ...
    darshan: {
      timings: 'Summer: 5:00 AM - 12:00 PM, 4:00 PM - 9:00 PM | Winter: 6:00 AM - 12:00 PM, 3:00 PM - 8:00 PM',
      specialNotes: 'Strict security protocols due to the site\'s religious sensitivity. Mobile phones, cameras, and electronic devices are not allowed. Long queues expected during Janmashtami and weekends.',
    ...
    faqs: [
      {
        question: 'Why are electronics not allowed inside Krishna Janmabhoomi?',
        answer: 'Due to the religious and historical sensitivity of the site, security protocols prohibit electronic devices including mobile phones and cameras. Secure locker facilities are provided at the entrance for visitors to store their belongings.'
      },
      {
        question: 'Can I visit both the temple and the exact birthplace cell?',
        answer: 'Yes, the temple complex includes both the main temple structure and the underground prison cell believed to be Krishna\'s birthplace. Both are part of the standard darshan route.'
      },
      {
        question: 'What is the best day to visit to avoid extreme crowds?',
        answer: 'Weekdays, especially Tuesday through Thursday, see relatively smaller crowds. Avoid weekends, Janmashtami, and major festival periods. Early morning visits immediately after opening time are recommended.'
      }
    ]
  },
  {
    ...
    darshan: {
      timings: 'Morning: 8:00 AM - 12:00 PM | Evening: 5:00 PM - 9:00 PM',
      specialNotes: 'Intimate atmosphere compared to larger temples. Traditional worship practices preserved. Classical music performances during certain festivals.',
    ...
    faqs: [
      {
        question: 'Why does Radha Vallabh Temple emphasize Radha more than Krishna?',
        answer: 'The Radhavallabh Sampradaya theological tradition views Radha as the supreme power and Krishna as her beloved. This temple reflects that philosophy, where Radha\'s presence is symbolized through her crown alongside the deity.'
      },
      {
        question: 'Is this temple suitable for first-time visitors to Vrindavan?',
        answer: 'Yes, though it offers a more traditional and less commercialized experience compared to major temples like Banke Bihari or Prem Mandir. It is ideal for visitors seeking a deeper, quieter spiritual experience.'
      },
      {
        question: 'Are there specific rituals or customs unique to this temple?',
        answer: 'The temple follows traditional Radhavallabh Sampradaya rituals, including specific forms of kirtan and worship. During major festivals, classical music performances are held. Visitors should observe and respect the temple\'s customs.'
      }
    ]
  }
];

export const spiritualPlaces = [
  {
    id: 'kesi-ghat',
    name: 'Kesi Ghat',
    location: 'Vrindavan',
